...
const RegisterModal = ({open, setOpen, getUsers}) => {
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Debe ingresar todos los datos solicitados para poder crear un nuevo usuario.
                        </p>
                      </div>
                    </div>
                  </div>
                </div>
                <RegisterForm open={open} setOpen={setOpen} getUsers={getUsers} />
              </Dialog.Panel>
            </Transition.Child>
          </div>
        </div>
